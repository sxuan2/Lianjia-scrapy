...
def urlmaker(nbr = 0, pgnbr = 1, entirerent_option = 1, option_1b = 0,option_2b = 1,option_3b = 0):
    url = urllist[nbr]
...
def get_info(): 
    ...
    for j in range(len(urllist)):
        url_1 = urlmaker(nbr = j, pgnbr = 1, entirerent_option = 1, option_1b = 0,option_2b = 1,option_3b = 0)
    #    默认两室整租
        ...
        for i in range(pgnbr_to): 
            url_to_scrape = urlmaker(nbr = j, pgnbr = i, entirerent_option = 1, option_1b = 0,option_2b = 1,option_3b = 0)
